...
def equations(vars):
    ...
    f1 = (-1.327 - 7.286e-4 * aunp.cos(theta2) + 4.858 * aunp.sin(theta2) - 1.821e-4 * V3 * aunp.cos(theta2 - theta3) +
    ...
    f5 = (0.5 + 9.619 * V3 ** 2 - 1.819e-4 * V3 * aunp.sin(theta3) - 2.068 * V3 * aunp.cos(theta3) -
    ...
    f6 = (0.4 + 5.303 * V5 ** 2 - 1.748e-3 * V5 * aunp.sin(theta5 - theta2) -
...
def calculate_power(V, theta):
    ...
    P1 = (V1 * V1 * (0.0008396019865774078 * math.cos(theta1 - theta1) + -6.337767838261236 * math.sin(theta1 - theta1))
    ...
    Q1 = (V1 * V1 * (0.0008396019865774078 * math.sin(theta1 - theta1) + 6.337767838261236 * math.cos(theta1 - theta1))
    ...
    P2 = (V2 * V2 * (0.0029096112357777024 * math.cos(theta2 - theta2) - 11.569565435823524 * math.sin(theta2 - theta2))
    ...
    Q2 = (V2 * V2 * (0.0029096112357777024 * math.sin(theta2 - theta2) + 11.569565435823524 * math.cos(theta2 - theta2))
    ...
    P3 = (V3 * V1 * (-0.0001723225898264885 * math.cos(theta3 - theta1) + 1.9694010265884399 * math.sin(theta3 - theta1))
          ...
          + V3 * V3 * (0.002646380126470728 * math.cos(theta3 - theta3) - 9.619106964166482 * math.sin(theta3 - theta3))
    ...
    Q4 = (V4 * V1 * (0.0 * math.sin(theta4 - theta1) - 0.0 * math.cos(theta4 - theta1))
          + V4 * V2 * (-0.0003867187304223643 * math.sin(theta4 - theta2) - 1.7187499129882857 * math.cos(
                theta4 - theta2))
          + V4 * V3 * (-0.0022989996680244477 * math.sin(theta4 - theta3) - 6.049999126380126 * math.cos(
                theta4 - theta3))
          + V4 * V4 * (0.002862103235793156 * math.sin(theta4 - theta4) + 9.18998199114892 * math.cos(
                theta4 - theta4))
          + V4 * V5 * (-0.00017638483734634384 * math.sin(theta4 - theta5) - 1.5433673267805086 * math.cos(
                theta4 - theta5)))
...
initial_vars = aunp.array([1.0, 1.0, 0, 0, 0, 0])
